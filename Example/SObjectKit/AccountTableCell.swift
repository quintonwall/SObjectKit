...
open class AccountTableCell : UITableViewCell, MKMapViewDelegate {
    ...
    open func bind(_ account : Account) {
        ...
        accountPhoto.sd_setImage(with: account.PhotoFullUrl, placeholderImage: UIImage(named: "account-placeholder"))
